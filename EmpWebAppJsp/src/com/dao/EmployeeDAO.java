...
public class EmployeeDAO {
	...
	public int delete(int empid) {
		Connection con = null;
		String SELECT = "delete from empschema.Employee where empId=?";
	...
	public int update(int id,String name,double salary)
	{
		Connection con = null;
		String SELECT = "update Employee set empName = ?,empSalary =? where empid = ?";
